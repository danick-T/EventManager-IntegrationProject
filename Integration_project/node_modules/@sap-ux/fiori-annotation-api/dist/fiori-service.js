...
class FioriAnnotationService {
    ...
    static async createService(project, serviceName, appName, fs, options = {}) {
        const vocabularyAPI = project.projectType === 'CAPJava' || project.projectType === 'CAPNodejs'
            ? cds_1.CDS_VOCABULARY_SERVICE
            : xml_1.XML_VOCABULARY_SERVICE;
        ...
        const changeConverter = new change_converter_1.ChangeConverter(serviceName, vocabularyAPI, adapter.metadataService, adapter.splitAnnotationSupport, finalOptions.ignoreChangedFileInitialContent);
...
async function getService(project, serviceName, appName, fsEditor, clearCache) {
    if (project.projectType === 'EDMXBackend') {
        ...
        return (0, cds_1.getCDSService)(project.root, serviceName, fileCache, clearCache);
    }
    else {
...
function createAdapter(project, service, vocabularyService, appName, writeSapAnnotations, ignoreChangedFileInitialContent) {
    if (service.type === 'local-edmx') {
        ...
        return new cds_1.CDSAnnotationServiceAdapter(service, project, vocabularyService, appName, writeSapAnnotations, ignoreChangedFileInitialContent);
    }
    else {
