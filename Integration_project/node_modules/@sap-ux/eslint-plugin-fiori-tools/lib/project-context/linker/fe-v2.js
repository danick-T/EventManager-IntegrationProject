 ...
 * @param createMode
 */
function createPageConfiguration(path, name, createMode) {
    return {
        createMode: {
            values: createModeValues,
